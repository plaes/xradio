...
//add by yangfh
void wsm_upper_restart(struct cw1200_common *priv);
...
/* 3.11 */
int wsm_stop_scan(struct cw1200_common *priv, int if_id);
...
int wsm_join(struct cw1200_common *priv, struct wsm_join *arg, int if_id);
...
int wsm_start_find(struct cw1200_common *priv, int if_id);

int wsm_stop_find(struct cw1200_common *priv, int if_id);
...
int wsm_deinit_release_buffer(struct cw1200_common *priv);
...
#endif
int wsm_11k_measure_requset(struct cw1200_common  *priv,
                                               u8  measure_type,
                                              u16  ChannelNum,
                                              u16  Duration);


static inline int wsm_set_fw_debug_control(struct cw1200_common *priv,
...
static inline int wsm_set_host_sleep(struct cw1200_common *priv,
...
static inline int wsm_get_ampducounters_table(struct cw1200_common *priv,
...
static inline int wsm_get_txpipe_table(struct cw1200_common *priv,
...
static inline int wsm_get_backoff_dbg(struct cw1200_common *priv,
...
static inline int wsm_set_backoff_ctrl(struct cw1200_common *priv,
...
static inline int wsm_set_tala(struct cw1200_common *priv,
...
static inline int wsm_set_inactivity(struct cw1200_common *priv,
...
static inline int wsm_set_forwarding_offlad(struct cw1200_common *priv,
...
int wsm_handle_rx(struct cw1200_common *priv, u16 id, struct wsm_hdr *wsm,
		  struct sk_buff **skb_p);
void wms_send_deauth_to_self(struct cw1200_common *priv, struct cw1200_vif *priv);
void wms_send_disassoc_to_self(struct cw1200_common *priv, struct cw1200_vif *priv);
